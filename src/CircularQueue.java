...
public class CircularQueue implements Queue {
  ...
  public void addBack(Object object) throws FullQueueException {
    ...
    queue[backIndex] = (PrintJob)object;
   ...
   */
  public PrintJob getFront() throws EmptyQueueException {
   ...
   * @throws EmptyQueueException  when the queue is empty
   */
  public PrintJob removeFront() throws EmptyQueueException {
    if ( frontIndex == backIndex ) {
      throw new EmptyQueueException(this);
    }
    PrintJob object = queue[frontIndex];
